...
$fpdf->Cell(80,5,"Descripcion:", 1, 0, "C",1);
...
$fpdf->Cell(80,5,$row["descripcioncat"], 1, 0, "C",1);
$fpdf->ln();
...
$fpdf->Cell(15,5,$row["proveedor_id"], 1, 0, "C",1);
$fpdf->Cell(40,5,$row["nombre_prove"], 1, 0, "C",1);
