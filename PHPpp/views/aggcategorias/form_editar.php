...
<dicv class="cuadro1">
  ...
  <br>
    ...
    <form class="container" action="../../controllers/CRUDcategorias/editardatos.php" method="POST">
        <?php
        ...
        if (isset($_GET['Id'])) {
            ...
            $stmt2 = $conn->prepare("SELECT * FROM categoria WHERE categoria_id = ?");
        ...
        $conn->close();
        ?>
            <input type="hidden" class="form-control mb-3" name="idC" value="<?php echo htmlspecialchars($row2['categoria_id'], ENT_QUOTES, 'UTF-8'); ?>">

            <div class="mb-3">
                <label class="form-label">Nombre de la categoria</label>
                <input type="text" class="form-control" name="nombreC" value="<?php echo htmlspecialchars($row2['nombrecat'], ENT_QUOTES, 'UTF-8'); ?>" required>
            </div>

            <div class="mb-3">
                <label class="form-label">Descripcion de la categoria</label>
                <input type="text" class="form-control" name="descripcionC" value="<?php echo htmlspecialchars($row2['descripcioncat'], ENT_QUOTES, 'UTF-8'); ?>" required>
            </div>
