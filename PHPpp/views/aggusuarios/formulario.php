...
<dicv class="cuadro1">
 ...
 <br><br>
    ...
    <form action="../../../controllers/CRUDusuarios/aggdatos.php" method="POST">
  <div class="mb-3">
  ...
  <button type="submit" onclick="return confirm('¿Confirmas los datos del nuevo usuario?')" class="btn btn-primary">Enviar</button>
