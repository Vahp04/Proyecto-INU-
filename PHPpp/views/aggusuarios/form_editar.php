...
<dicv class="cuadro1">
  ...
  <br>
    ...
    <form class="container" action="../../controllers/CRUDusuarios/editardatos.php" method="POST">
        <?php
        ...
        ?>
            ...
            <div class="text-center">
                <button type="submit" onclick="return confirm('¿Confirmas los datos para editar el usuario?')" class="btn btn-primary">Enviar</button>
