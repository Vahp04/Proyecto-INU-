...
<dicv class="cuadro1">
 ...
 <br><br>
    ...
    <form action="../../../controllers/CRUDclientes/aggdatos.php" method="POST">
  <div class="mb-3">
  ...
  <button type="submit" onclick="return confirm('¿Confirmas los datos del nuevo cliente?')" class="btn btn-primary">Enviar</button>
