...
<dicv class="cuadro1">
 ...
 <br><br><br>
    ...
    <form action="../../controllers/CRUDproveedores/aggdatos.php" method="POST">
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="direccionProve">

    <div class="mb-3">
    <label class="form-label">Telefono del proveedor</label>
    <input type="text" class="form-control" name="telefonoProve">
  </div>

  </div>
  <div class="text-center">
  <button type="submit" onclick="return confirm('¿Confirmas los datos del nuevo proveedor?')" class="btn btn-primary">Enviar</button>
