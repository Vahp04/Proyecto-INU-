...
.datepicker {
    width: 700px; /* ancho del datepicker */
    height: 30px; /* alto del datepicker */
    background-color: #f0f0f0; /* color de fondo del datepicker */
    border: 1px solid #ccc; /* borde del datepicker */
    border-radius: 5px; /* radio de esquina del datepicker */
    padding: 3px; /* espacio entre el texto y el borde del datepicker */
    font-size: 16px; /* tamaño de fuente del texto del datepicker */
    color: #333; /* color del texto del datepicker */
    cursor: pointer; /* cursor para indicar que es un elemento interactuable */
    text-align: center; /* centrar el texto dentro del datepicker */
  }
...
<dicv class="cuadro1">
 ...
 <br><br><br>
    ...
    <form action="../../controllers/CRUDentradas/aggdatos.php" method="POST">
  <div class="mb-3">
...
<option value="<?php echo $resultado['nombrepr'];?>"><?php echo $resultado['nombrepr'];?></option>
  ...
  <div class="mb-3">
    <label class="form-label">Cantidad ingresante</label>
  ...
  <script>
    ...
    document.getElementById("fecha_hoy").value = fechaHoy.toLocaleDateString("es-ES", { year: 'numeric', month: '2-digit', day: '2-digit' });
  </script>
    <div class="mb-3">
  ...
  <button type="submit" onclick="return confirm('¿Confirmas la cantidad a añadir de productos?')" class="btn btn-primary">Enviar</button>
