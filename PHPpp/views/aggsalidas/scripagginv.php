...
<dicv class="cuadro1">
 ...
 <br><br><br>
    ...
    <form action="../../controllers/CRUDsalidas/aggdatos.php" method="POST">
  <div class="mb-3">
    <label class="form-label">Producto a retirar</label>
    <br>
...
<option value="<?php echo $resultado['nombrepr'];?>"><?php echo $resultado['nombrepr'];?></option>
  ...
  <button type="submit" onclick="return confirm('¿Estás seguro de que deseas retirar la cantidad de productos seleccionada?')" class="btn btn-primary">Enviar </button>
